...
public class Tblskills implements Serializable {
    ...
    private Collection<Tbljobskills> tbljobskillsCollection;
    @OneToMany(mappedBy = "skillId")
    private Collection<Tblcandidateskills> tblcandidateskillsCollection;
    ...
    @XmlTransient
    @JsonbTransient
    public Collection<Tbljobskills> getTbljobskillsCollection() {
        return tbljobskillsCollection;
    }

    public void setTbljobskillsCollection(Collection<Tbljobskills> tbljobskillsCollection) {
        this.tbljobskillsCollection = tbljobskillsCollection;
    }

    @XmlTransient
    @JsonbTransient
    public Collection<Tblcandidateskills> getTblcandidateskillsCollection() {
        return tblcandidateskillsCollection;
    }

    public void setTblcandidateskillsCollection(Collection<Tblcandidateskills> tblcandidateskillsCollection) {
        this.tblcandidateskillsCollection = tblcandidateskillsCollection;
    }
